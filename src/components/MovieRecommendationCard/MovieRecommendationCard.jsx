...
const MovieRecommendationCard = ({
  ...
  director,
  actors,
  posterLink, // Corresponds to 'image'
  imdbLink,
    ...
    >
      ...
      <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto flex-grow h-12 bg-red-700 border border-white/20 hover:bg-red-800 text-white text-md font-bold rounded-md transition-colors"
        >
